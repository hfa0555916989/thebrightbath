...
// Script lives at Laravel root now (no nested public_html structure)
$laravelRoot = __DIR__;

if (!file_exists("$laravelRoot/artisan") || !is_dir("$laravelRoot/app")) {
    foreach ([dirname(__DIR__), '/home/u354011138/public_html', '/home/u354011138/domains/thebrightbath.com'] as $c) {
