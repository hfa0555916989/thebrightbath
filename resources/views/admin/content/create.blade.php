...
<div class="space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-2xl font-bold text-brand-dark">إضافة عنصر جديد</h2>
    ...
    <form method="POST" action="{{ route('admin.content.store', $type) }}" enctype="multipart/form-data">
        @csrf
        @include('admin.content._form', ['item' => null])
